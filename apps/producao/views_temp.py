...
from .models import (
    ...
    LinhaProducao, ControleProducao, StatusOP, PrioridadeOP,
    HistoricoProducao, StatusLinha
)

# Importações do novo app estoque
from apps.estoque.models import MateriaPrima, MovimentacaoEstoque
...
# Importações do novo app estoque para forms
from apps.estoque.forms import MateriaPrimaForm, EntradaEstoqueForm

from apps.core.mixins import TenantMixin
from apps.core.utils import get_current_empresa
...
def relatorios_producao(request):
    ...
    # ========== MATERIAIS ==========
    # MateriaPrima já importada do app estoque no topo do arquivo
